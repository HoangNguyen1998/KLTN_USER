                ...
                return (
                    <Grid item xs={ 12 } lg={ 4 } key={ index }>
                        <div className="paper-container">
                            <Paper className="paper"><div className="paper-custom__image">
                                { item.showStar ?
                                    <StarIcon onClick={ () => item.showStar = !!!item.showStar } style={ { fontSize: 30, margin: "0.5rem 0.5rem 0 0", color: "yellow" } } />
                                    : <StarBorderIcon onClick={ () => item.showStar = !!!item.showStar } style={ { fontSize: 30, margin: "0.5rem 0.5rem 0 0", } } /> }
                            </div>
                                <div>
        ...
        <div className="courses-list-container">
            ...
            <div className="button">
                <Tooltip title={ t("CreateCourse") }>
                    <IconButton className="general-color" onClick={ onShowCreateCourse }>
                        <AddCircleIcon style={ { fontSize: 40 } } />
                    </IconButton>
                    <Button style={ { fontSize: 25, backgroundColor: "red" } }><h1>Hello</h1></Button>
                </Tooltip>
            </div>
            ...
            <Dialog onClose={ onHideCreateCourse } fullScreen open={ showModal }>
                <div className="modal-create-course">
                    <Tooltip className="modal-create-course__icon-close">
                        <IconButton onClick={ onHideCreateCourse }><CloseIcon style={ { fontSize: 25 } } />
                        </IconButton>
                        <IconButton><h1>Hello</h1>
                        </IconButton>
                    </Tooltip>
                    <AddCourse history={ history } enqueueSnackbar={ enqueueSnackbar } t={ t } />
                </div>
            </Dialog>
        </div>
    )
