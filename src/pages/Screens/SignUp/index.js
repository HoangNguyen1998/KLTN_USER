...
const SignUp = (props) => {
    ...
    const _onHandleSubmit = (event) => {
        ...
        if (email !== "" && username !== "" && password !== "") {
            dispatch(
                SignUpActions.SignUpRequest(user, history, t, enqueueSnackbar)
            );
        }
    };
        ...
        <Grid container component="main" className={classes.root}>
            ...
            >
                ...
                <div className={classes.paper}>
                    <Avatar style={{backgroundColor: "#009be5"}} className={classes.avatar}>
                        <LockOutlinedIcon  />
                    </Avatar>
                    ...
                    <form className={classes.form} onSubmit={_onHandleSubmit}>
                        ...
                        <TextField
                            ...
                            onChange={handleChange}
                            onKeyUp={() =>
                                setFieldTouched("retypepassword", true, false)
                            }
                            InputProps={{
                                endAdornment: (
                                    <IconButton
