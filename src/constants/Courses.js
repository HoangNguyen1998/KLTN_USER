...
export const SAVE_ANSWER_HISTORY = "SAVE_WORD_HISTORY";

// cap nhat ngu phap trong khoa hoc (1 tu)
export const UPDATE_DETAIL_ONE_REQUEST = "UPDATE_DETAIL_ONE_REQUEST";
export const UPDATE_DETAIL_ONE_SUCCESS = "UPDATE_DETAIL_ONE_SUCCESS";
