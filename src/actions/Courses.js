...
// luu lich su tra loi cau hoi
export const Save_Answer_History = (id) => {
    return {
        type: CoursesConstants.SAVE_ANSWER_HISTORY,
        payload: id,
    };
};

// cap nhat ngu phap trong khoa hoc (1 tu)
export const Update_Detail_One_Request = (data) => {
    return {
        type: CoursesConstants.UPDATE_DETAIL_ONE_REQUEST,
        payload: data,
    };
};

export const Update_Detail_One_Success = (data) => {
    return {
        type: CoursesConstants.UPDATE_DETAIL_ONE_SUCCESS,
        payload: data,
    };
};
